...
export function NodeDetailPanel() {
    const { activeNodeId, persistedNodes, draftNodes, nodes, setActiveNode } = useGraphStore();
    ...
    const activeNode = [...persistedNodes, ...draftNodes, ...nodes].find((n: Node) => n.id === activeNodeId);
